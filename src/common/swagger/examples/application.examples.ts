    ...
    strong: {
      ...
      value: {
        application: JSON.stringify({
          ...
          statement: 'I am passionate about AI research and have completed relevant coursework in machine learning and neural networks. I have also contributed to open-source ML projects...'
        })
      }
    },
    basic: {
...
reject: {
    ...
    value: {
    status: 'REJECTED',
    professorNotes: 'Thank you for your interest, but we are looking for candidates with more research experience.'
    }
}
};